...
#############################################################################
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
                ...
                'salesperson_pos_order_line/static/src/js/payment_screen_patch.js',
                'salesperson_pos_order_line/static/src/js/tip_popup.js',
                'salesperson_pos_order_line/static/src/xml/pos_service_tip_popup.xml',
