...
!(function (t) {
        ...
        o(e, [
          {
            ...
            value: function () {
              for (var t = "110", e = 0; e < this.data.length; e++) {
                ...
                n = u(n, 4 - n.length);
                for (var r = 0; r < n.length; r++) t += n[r] == "0" ? "100" : "110";
              }
    ...
    var f = (function (t) {
      function e(t, n) {
        ...
        var r = (function (t, e) {
          ...
          this,
          (e.__proto__ || Object.getPrototypeOf(e)).call(this, t.substring(1), n)
        );
        return (
        ...
        r(e, [
          {
            ...
            value: function () {
              return (
                this.data.search(/^[0-9]{12}$/) !== -1 && this.data[11] == u(this.data)
              );
            },
          },
          {
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0}),
      (e.default = function (t) {
        ...
        for (var n in e)
          e.hasOwnProperty(n) &&
            ((n = e[n]), typeof t[n] === "string" && (t[n] = parseInt(t[n], 10)));
  ...
  function (t, e, n) {
    ...
    function u(t, e, n) {
      if (n.displayValue && e < t) {
        if (n.textAlign == "center") return Math.floor((t - e) / 2);
        if (n.textAlign == "left") return 0;
        if (n.textAlign == "right") return Math.floor(t - e);
      }
      return 0;
    }
    function f(t, e, n) {
  ...
  function (t, e, n) {
        ...
        d.prototype[e.toLowerCase()] =
          function (n, r) {
            ...
            return i._errorHandler.wrapBarcodeCall(function () {
              r.text = void 0 === r.text ? void 0 : String(r.text);
    ...
    (d.prototype.options = function (t) {
      ...
      typeof window !== "undefined" && (window.JsBarcode = h),
          ...
          o(e, [
            {
              ...
              value: function () {
                return (
                  ...
                  Number(this.data[12]) === c(this.data)
                );
              },
            },
            {
          ...
          o(e, [
            {
              ...
              value: function () {
                return (
                  ...
                  Number(this.data[7]) === f(this.data)
                );
              },
            },
            {
  ...
  function (t, e, n) {
      ...
      l = (function (t) {
        function e(t, n) {
          ...
          if (((r.isValid = !1), t.search(/^[0-9]{6}$/) !== -1))
            (r.middleDigits = t),
              (r.upcA = p(t, "0")),
              (r.text = n.text || String(r.upcA[0]) + t + r.upcA[r.upcA.length - 1]),
              (r.isValid = !0);
          else {
            if (t.search(/^[01][0-9]{7}$/) === -1) return f(r);
            if (
    ...
    function p(t, e) {
      ...
      return String(o = String(e) + o) + (0, a.checksum)(o);
    }
    e.default = l;
  },
  function (t, e, n) {
          ...
          o(e, [
            {
              ...
              value: function () {
                return (
                  ...
                  Number(this.data[13]) === u(this.data)
                );
              },
            },
          ]),
        ...
        o(e, [
          {
            key: "encode",
            value: function () {
              for (var t = this.number, e = ""; !isNaN(t) && t != 0; )
                t % 2 == 0
                  ? ((e = "11100" + e), (t = (t - 2) / 2))
                  : ((e = "100" + e), (t = (t - 1) / 2));
  ...
  function (t, e, n) {
    ...
    function f(t) {
      ...
      if (typeof HTMLCanvasElement !== "undefined" && t instanceof HTMLImageElement)
        return (
          (u = t),
          {
      ...
      if (
        ...
        (typeof SVGElement !== "undefined" && t instanceof SVGElement)
      )
        return {
          element: t,
      ...
      if (typeof HTMLCanvasElement !== "undefined" && t instanceof HTMLCanvasElement)
        return {
          element: t,
          options: (0, o.default)(t),
          renderer: i.default.CanvasRenderer,
      ...
      if (t && (void 0 === t ? "undefined" : r(t)) === "object" && !t.nodeName)
          ...
          o(t, [
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var r,
                  o = n.data;
                r = e.textPosition == "top" ? e.fontSize + e.textMargin : 0;
                for (var i = 0, a = 0, u = 0; u < o.length; u++)
                  (a = u * e.width + n.barcodePadding),
                    o[u] === "1"
                      ? i++
                      : i > 0 &&
                        (this.drawRect(a - e.width * i, r, e.width * i, e.height, t),
                        (i = 0));
                i > 0 &&
                  this.drawRect(a - e.width * (i - 1), r, e.width * i, e.height, t);
              },
            },
            {
              key: "drawSVGText",
              value: function (t, e, n) {
                ...
                e.displayValue &&
                  ...
                  e.textAlign == "left" || n.barcodePadding > 0
        ...
        r(t, [
          {
            key: "handleCatch",
            value: function (t) {
              if (t.name !== "InvalidInputException") throw t;
